...
public abstract partial class LzItemViewModel<TId, TDTO, TModel>
    : LzViewModel,
    ...
    where TModel : class, TDTO, IRegisterObservables, new()
{
    ...
    public ILzParentViewModel<TId>? ParentViewModel { get; set; } 
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public virtual Task<(bool, string)> CheckIdAsync(TId? id = default)
    {
        id ??= Id!; 
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public virtual async Task<(bool, string)> DeleteAsync(TId? id = default)
    {
        IsBusy = true;  
        try
        {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public virtual async Task<(bool, string)> ReadAsync(TId? id = default)
    {
        IsBusy = true;  

...
//    /// <summary>
//    /// Use this constructor for Read operations.
//    /// </summary>
//    /// <param name="entityType"></param>
//    /// <param name="dbRecord"></param>
//    public DYDBDataEnvelope(
//        string entityType,
//        Dictionary<string, AttributeValue> dbRecord
//        )
//    {
...
//        }
//    }
//    protected JObject JObjectData { get; set; }
//    protected string JsonData { get; set; }
//    protected Func<string, object>? _deserialize { get; init; }
...
//    /// </summary>
//    public virtual void SealEnvelope(string pk, string sk, string typeName)
//    {
//        PK = pk;
//        SK = sk;
//        TypeName = typeName;
...
//        // deserialize the json data to the EntityInstance
//        // _deseriliaze delegate is set in the constructor and usually 
//        // defined in the DYDBRepository class.
//        if (_dbRecord.TryGetValue("Data", out AttributeValue data))
//        {
//            JsonSize = data.S.Length;
//            EntityInstance = _deserialize(data.S);
//        }

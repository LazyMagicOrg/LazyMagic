...
| **process-all.js** | Multi-project orchestrator - auto-detects and processes all projects | input/*.svg, input/*-combinations.json | output/*/Level1-output.svg |
...
- **Utility Files:** 2 files
- **Input Directory:** 3 files (Rooms.json, Level1.svg, Level1-combinations.json)
- **Output Directory:** Generated per project
- **Total Essential Files:** ~20 files (excluding node_modules and generated output)
...
│   ├── process-all.js                   (Multi-project orchestrator)
...
Total: ~20 essential files (excluding generated outputs)
```
...
**New Multi-Project Script:**
- `npm run process` - Automatically detects and processes all projects in input/ directory
...
4. `input/Level1-combinations.json` - Project-specific valid combinations
5. `process-all.js` - Multi-project orchestrator
